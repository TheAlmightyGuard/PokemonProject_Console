...
namespace PokemonGame
{
    class Password_Class
    {
        public static bool mainPassword(string userIn)
        {
            ...
            MongoFunctions.readInformation(userIn, out Guid userid, out string password, out string userOut, out int lvl, out int coins, out List<MongoFunctions.PartySAMPLE> party);
            ConsoleKey key;
